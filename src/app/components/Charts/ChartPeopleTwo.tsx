...
const ChartPeopleTwo: React.FC = () => {
  const [state, setState] = useState<PeopleStateTwo>({
    series: [],
  });
  ...
  useEffect(() => {
    if (data) {
      ...
      const salarios = data.results.map((item: any) => item.salario);
